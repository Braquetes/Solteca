...
$distinto = mysqli_query($conexion, "SELECT DISTINCT Numero_Autobus FROM `carrito` WHERE `Fecha_salida` BETWEEN '".$params->fechaInicio."' AND
'".$params->fechaFinal."' AND `Id_sucursal` = '".$params->sucursal."' ");
